...
use backend\modules\content\models\Projects;
use backend\widgets\SingleImagePreviewWidget;
use yii\helpers\Html;
use yii\bootstrap5\ActiveForm;

/** @var yii\web\View $this */
/** @var backend\modules\content\models\Projects $model */
                            ...
                            <?php if(isset($model->image) && !empty($model->image)): ?>
                                <div class="row">
                                    <?= SingleImagePreviewWidget::widget([
                                        'id' => $model->id,
                                        'filePath' => $model->getUrl(Projects::UPLOAD_PATH, $model->image),
                                        'url' => 'delete-image',
...
<?= $this->render('//layouts/forms/_buttons', ['formId' => 'projects-form']); ?>